...
namespace CircularCrashTest
{
    ...
    static class Program
    {
        static void Main(string[] args)
        {
            ...
            builder.RegisterType<Class1>().As<IClass1>().PropertiesAutowired(PropertyWiringOptions.AllowCircularDependencies).InstancePerLifetimeScope();
            builder.RegisterType<Class2>().As<IClass2>().PropertiesAutowired(PropertyWiringOptions.AllowCircularDependencies).InstancePerLifetimeScope();
